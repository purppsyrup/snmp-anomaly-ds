...
xgb_model = load('xgb-0.1.14.joblib')
scaler = load('scaler-0.1.14.joblib')
label_encoder = load('enc-0.1.14.joblib')
scaler_params = np.load('params-0.1.14.npy', allow_pickle=True).item()
...
def main():
    ...
    csv_file = 'xgb-0.1.14.csv'
    diff_csv_file = 'diff-0.1.14.csv'
