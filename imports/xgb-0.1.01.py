...
xgb_model = load('xgb-0.1.01.joblib')
scaler = load('scaler-0.1.01.joblib')
label_encoder = load('enc-0.1.01.joblib')
scaler_params = np.load('params-0.1.01.npy', allow_pickle=True).item()
...
def get_snmp_metrics(host, community_string):
    oids = [
        ...
        '1.3.6.1.2.1.2.2.1.12.3',      # ifInNUcastPkts11
...
def append_to_csv(metrics, prediction, csv_file):
    column_names = [
        'ifInOctets11', 'ifInUcastPkts11', 'ifInNUcastPkts11', 'ifOutUcastPkts11', 'ifOutNUcastPkts11',
        'tcpOutRsts', 'tcpOutSegs', 'tcpRetransSegs',
        'udpOutDatagrams', 'udpNoPorts',
        'ipInReceives', 'ipInDelivers', 'ipForwDatagrams',
        'icmpInDestUnreachs', 'icmpOutDestUnreachs', 'class'
    ]
...
def append_diff_to_csv(metrics_diff, prediction, csv_file):
    column_names = [
        'ifInOctets11_diff', 'ifInUcastPkts11_diff', 'ifInNUcastPkts11_diff', 'ifOutUcastPkts11_diff', 'ifOutNUcastPkts11_diff',
        'tcpOutRsts_diff', 'tcpOutSegs_diff', 'tcpRetransSegs_diff',
        'udpOutDatagrams_diff', 'udpNoPorts_diff',
        'ipInReceives_diff', 'ipInDelivers_diff', 'ipForwDatagrams_diff',
        'icmpInDestUnreachs_diff', 'icmpOutDestUnreachs_diff', 'class'
    ]
...
def main():
    ...
    csv_file = 'xgb-0.1.01.csv'
    diff_csv_file = 'diff-0.1.01.csv'
