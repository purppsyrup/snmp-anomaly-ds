...
xgb_model = load('xgb-1.0.z2.joblib')
scaler = load('scaler-1.0.z2.joblib')
label_encoder = load('enc-1.0.z2.joblib')

scaler_params = np.load('params-1.0.z2.npy', allow_pickle=True).item()
...
def main():
    ...
    csv_file = 'xgb-1.0.z2.csv'
    diff_csv_file = 'diff-1.0.z2.csv'
