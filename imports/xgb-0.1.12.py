...
xgb_model = load('xgb-0.1.12.joblib')
scaler = load('scaler-0.1.12.joblib')
label_encoder = load('enc-0.1.12.joblib')
scaler_params = np.load('params-0.1.12.npy', allow_pickle=True).item()
...
def get_snmp_metrics(host, community_string):
    oids = [
        ...
        '1.3.6.1.2.1.2.2.1.13.3',     # ifInDiscards11
        ...
        '1.3.6.1.2.1.4.10.0',          # ipInDelivers
        '1.3.6.1.2.1.4.9.0',           # ipOutRequests
        '1.3.6.1.2.1.4.13.0',          # ipInDiscards
        '1.3.6.1.2.1.4.7.0',           # ipInAddrErrors
...
def append_to_csv(metrics, prediction, csv_file):
    column_names = [
        'ifInOctets11', 'ifInDiscards11', 'tcpInSegs', 'tcpRetransSegs',
        'tcpEstabResets', 'udpInDatagrams', 'udpOutDatagrams', 'ipInReceives',
        'ipInDelivers', 'ipOutRequests', 'ipInDiscards', 'ipInAddrErrors',
        'icmpInMsgs', 'class'
    ]
...
def append_diff_to_csv(metrics_diff, prediction, csv_file):
    column_names = [
        'ifInOctets11_diff', 'ifInDiscards11_diff', 'tcpInSegs_diff', 'tcpRetransSegs_diff',
        'tcpEstabResets_diff', 'udpInDatagrams_diff', 'udpOutDatagrams_diff', 'ipInReceives_diff',
        'ipInDelivers_diff', 'ipOutRequests_diff', 'ipInDiscards_diff', 'ipInAddrErrors_diff',
        'icmpInMsgs_diff', 'class'
    ]
...
def main():
    ...
    csv_file = 'xgb-0.1.12.csv'
    diff_csv_file = 'diff-0.1.12.csv'
